        ...
        <Modal isOpen={this.state.modalInsertar}>
                ...
                <ModalBody>
                  ...
                  <label htmlFor="id">INGRESO DE PERSONAL</label>
                    ...
                    <input className="form-control" type="text" name="cedulaPersonal" id="cedulaPersonal" onChange={this.handleChange} value={form.cedulaPersonal}/>
                    <br />
                  
                    <label htmlFor="nombrePersonal">Nombres</label>
                    <input className="form-control" type="text" name="nombrePersonal" id="nombrePersonal" onChange={this.handleChange} value={form.nombrePersonal}/>
                    <br />
                    
                    <label htmlFor="apellidoPersonal">Apellidos</label>
                    <input className="form-control" type="text" name="apellidoPersonal" id="apellidoPersonal" onChange={this.handleChange} value={form.apellidoPersonal}/>
                    <br />
                  
                    <label htmlFor="fechaIngreso">Fecha de ingreso</label>
                    <input className="form-control" type="text" name="fechaIngreso" id="fechaIngreso" onChange={this.handleChange} value={form.fechaIngreso}/>
                    <br />
                  
                    <label htmlFor="Direccion">Direccion</label>
                    <input className="form-control" type="text" name="direccion" id="direccione" onChange={this.handleChange} value={form.direccion}/>
                    <br />
